export const data = [{ 
    ...
    title: "Please subscribe to view more exclusive contents.", image: require("../assets/images/localAd-1.png"), 
    }, { 
    id: 2,
    category: "advertisement",
    title: "2 months for only Rm15.90 for offline movies.", image: require("../assets/images/localAd-2.png"), 
    }, { 
    id: 3,
